...
mldsApp.controller('AdminDashboardController',
        [ '$scope', '$log', 'UserRegistrationService', 'DomainBlacklistService', 'PackagesService', function ($scope, $log, UserRegistrationService, DomainBlacklistService, PackagesService) {
