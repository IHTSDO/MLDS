...
-- Inserting data into t_authority table
INSERT INTO t_authority (name) VALUES ('ROLE_ADMIN');
INSERT INTO t_authority (name) VALUES ('ROLE_USER');
INSERT INTO t_authority (name) VALUES ('ROLE_STAFF');
INSERT INTO t_authority (name) VALUES ('ROLE_STAFF_SE');
INSERT INTO t_authority (name) VALUES ('ROLE_STAFF_IHTSDO');


-- Inserting data into t_user table
INSERT INTO t_user (login, user_id, password, first_name, last_name, email, activated, lang_key, activation_key, created_by, created_date, last_modified_by, last_modified_date)
VALUES
...
-- Inserting data into t_user_authority table
INSERT INTO t_user_authority (user_id, name)
VALUES
    (1, 'ROLE_ADMIN'),
    (1, 'ROLE_USER'),
    (3, 'ROLE_ADMIN'),
