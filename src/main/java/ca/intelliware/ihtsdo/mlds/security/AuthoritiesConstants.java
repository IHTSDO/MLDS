...
public final class AuthoritiesConstants {
    ...
    public static final String[] AUTHENTICATED = { USER, MEMBER, STAFF, ADMIN };
    public static final String[] PUBLIC = { ANONYMOUS, USER, MEMBER, STAFF, ADMIN };
    ...
    public static final String[] USER_OR_STAFF_ADMIN = { USER, STAFF, ADMIN };
