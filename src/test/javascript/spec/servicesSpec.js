...
describe('Services Tests ', function () {
    ...
    describe('AuditsService', function () {
        ...
        it('should call backend on findAll', function(){
            ...
            var returnData = { result: 'ok' };
            //expectGET to make sure this is called once.
            httpBackend.expectGET('/api/audits').respond(returnData);        
        ...
        it('should call backend on findByDates with filter', function(){
            ...
            var returnData = { result: 'ok' };
            //expectGET to make sure this is called once.
            httpBackend.expectGET('/api/audits?$filter=auditEventDate%20ge%20\'2014-01-01\'%20and%20auditEventDate%20le%20\'2014-01-09\'').respond(returnData);        
        ...
        it('should call backend on findByAuditEventType with filter', function(){
            ...
            var returnData = { result: 'ok' };
            //expectGET to make sure this is called once.
            httpBackend.expectGET('/api/audits?$filter=auditEventType%20eq%20\'TestType\'').respond(returnData);        
        ...
        it('should call backend on findByAffiliateId with filter', function(){
            ...
            var returnData = { result: 'ok' };
            //expectGET to make sure this is called once.
            httpBackend.expectGET('/api/audits?$filter=affiliateId%20eq%20\'123\'').respond(returnData);        
        ...
        it('should call backend on findByApplicationId with filter', function(){
            ...
            var returnData = { result: 'ok' };
            //expectGET to make sure this is called once.
            httpBackend.expectGET('/api/audits?$filter=applicationId%20eq%20\'123\'').respond(returnData);        
