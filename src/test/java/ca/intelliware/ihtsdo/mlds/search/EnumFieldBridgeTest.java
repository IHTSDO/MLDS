...
public class EnumFieldBridgeTest {
	...
	public void enumValueReturnsString() throws Exception {
		...
		String text = affiliateTypeFieldBridge.convertToDatabaseColumn(AffiliateType.ACADEMIC);
	...
	public void nullYieldsNull() throws Exception {
		...
		String text = affiliateTypeFieldBridge.convertToDatabaseColumn(null);
	...
	public void differentEnumGiveDifferentValues() throws Exception {
		...
		String text = affiliateTypeFieldBridge.convertToDatabaseColumn(AffiliateType.ACADEMIC);
		String text2 = affiliateTypeFieldBridge.convertToDatabaseColumn(AffiliateType.COMMERCIAL);
